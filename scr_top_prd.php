...
// scr_top_prd.php
	...
	$cFILE_USER = S_PARA('FTP_USER_FOLDER', '/home/riza/www/images/admin/'). $cUSERCODE.'.jpg';
...
*/ ?>
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<label  style="text-align:right" class="col-lg-2 col-xs-6">Periode</label>
				<?php
 					...
 					$dFINISH->add($INTERVAL);
 					$PERIOD_X  		= new DatePeriod($dSTART, $INTERVAL, $dFINISH);

					echo '<select name="SYS_THN" class="form-label-900 col-lg-3 col-md-4 col-sm-6 col-xs-6" id="SYS_THN" onchange="Select_Period(this.value)">';       // Select_Period() on sys_js.js
						foreach ($PERIOD_X as $dt) {
							$xYM = $dt->format("Y-m");
							if ($xYM==$_SESSION['sCURRENT_PERIOD'])
			...
			<div class="pull-right">
				<ul class="info-menu right-links list-inline list-unstyled">
                    <a class="fa fa-home" href="home.php" title="go to home" style="color:orange">home</a>
					...
					<li class="profile showopacity">
						 <a href="#" data-toggle="dropdown" class="toggle">
							  ...
							  <span><?php echo $cUSERCODE?> <i class="fa fa-angle-down"></i></span>
						 </a>
						 <ul class="dropdown-menu profile animated fadeIn">
							  ...
							  <li>	<a href="<?php echo $HELP_FILE; ?>"> <i class="fa fa-info"></i>   	Help		</a>	</li>
							  <li class="last">
									<a href="logout.php?id=<?php echo $cUSERCODE?>">
